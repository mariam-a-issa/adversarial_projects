...
class OnlineHD(object):
    ...
    Example:
        ...
        torch.Size([1000])
    '''
    def __init__(self, classes : int, features : int,randgen=None, dim : int = 4000):
        self.classes = classes
        self.dim = dim
        self.encoder = Encoder(features, dim,randgen=randgen)
        self.model = torch.complex(torch.zeros(self.classes, self.dim),torch.zeros(self.classes, self.dim))
